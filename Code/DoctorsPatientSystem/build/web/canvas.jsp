                ...
                $("#btn2").click(function () {
                    if ($("#userid").val() != "" && $("#username").val() != "" && $("#password").val() != "" && $("#mail").val() != ""
                        ...
                        if (($("#password").val() != $("#password1").val()) || ($("#mail").val() != $("#mail1").val())) {
                            ...
                            if ((data != null && $("#select").val() == "Doctors")) {
                                $.post('save', {data: data, id: $("#userid").val(), name: $("#username").val(), pswd: $("#password").val(), mail: $("#mail").val(), addr: $("#addr").val(), place: $("#place").val(), state: $("#state").val(), country: $("#Country").val(), zip: $("#zip").val(), phone: $("#phone").val(), job: $("#job").val(), ofc: $("#ofc").val(), type: $("#select").val()}, alert("D Registered Succefully"));
                            }
                            else/* if ((data != null && $("#select").val() == "Patients")) */{
                                $.post('save', {data: data, id: $("#userid").val(), name: $("#username").val(), pswd: $("#password").val(), mail: $("#mail").val(), addr: $("#addr").val(), place: $("#place").val(), state: $("#state").val(), country: $("#Country").val(), zip: $("#zip").val(), phone: $("#phone").val(), job: $("#job").val(), ofc: $("#ofc").val(), type: $("#select").val()}, alert("P Registered Succefully"));
                            }/*
                            else {
                                alert("Invalid");
                            }*/
        ...
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    ...
                    <p id="r1">The goal of this system is to bring the benefits of telemedicine to nursing home residents in an inexpensive, convenient manner. This can be achieved by demonstrating the feasibility of producing a portable telemedicine kit connected to a telemedicine network through video conferencing.
