...
<script type="text/javascript" language="javascript">
    function call(){
        alert("For Best Functinality, Please use Google Chrome");
        var ans=confirm("Do you want to Install Chrome?");
        if(ans==true){
...
<div id="wrapper">
  <div id="header">
    <div id="logo">
      <%-- <h1><a href="#"><font face="brush script mt" size="6">E-HEALTHCARE</font></a></h1>--%>
      <p><img src="images/ehealthcare.jpg" width="100%" height="auto" alt="E-HEALTHCARE"/></p>
    </div>
  ...
  <div id="page">
    <div id="content">
      ...
      <p>The goal of this system is to bring the benefits of telemedicine to nursing home residents in an inexpensive, convenient manner. This can be achieved by demonstrating the feasibility of producing a portable telemedicine kit connected to a telemedicine network through video conferencing.
        ...
        Enter Bengali/English text through Online OHR to make the conversation more feasible and compact. </p>
      <img src="images/C-DAC2.png" height="auto" max-width="100%" alt=""/> </div>
    <div id="sidebar">
      <div id="tbox1">
        <h2>some words</h2>
        <ul class="style2">
          <li class="first">
            <h3><a href="index.jsp?type=Doctors">Doctors Area</a></h3>
          ...
          <li>
            <h3><a href="index.jsp?type=Patients">Patients Page</a></h3>
            <p><img src="images/img04.jpg" width="200" height="150" alt="" /></p>
            <p>Patients can register and login to get the hand written
              Bengali prescription.</p>
          </li>
          <li>
